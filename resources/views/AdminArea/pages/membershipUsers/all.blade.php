...
<div class="content">
    <div class="row align-items-center p-0 m-0">
        ...
        <div class="col-md-6 text-right p-0 m-0">
            <div class="breadcrumb-wrapper">
                <a href="{{url('admin/membership/add')}}" class="btn btn-primary">
                    <span class="fa fa-plus-circle"></span> Add Free Membership
                </a>
            </div>
        </div>
    </div>
        ...
        $.confirm({
            ...
            buttons: {
                confirm: {
                    btnClass: 'btn-blue',
                    action: function () {
                        window.location.href = '{{ url("admin/membership/delete") }}/' + id;
                    }
                },
                cancel: {
                    action: function () {}
